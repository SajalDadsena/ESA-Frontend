    ...
    const getDates = async () => {
      try {
        ...
        const examsResponse = await axiosPrivate.get(url.concat('/get-exams'), {
          params: { date: init_date, time: "First-Half" },
          signal: controller.signal
        });
    ...
    <div className="bg-background flex flex-col flex-grow md:w-5/6">
      <div className="bg-background px-8 pt-4 flex flex-col st:flex-row justify-between">
        ...
        <div className="flex flex-row mt-6 items-center">
          ...
          <select ref={timeRef} defaultValue={"First-Half"} onChange={handleExams} className="h-10 px-3 py-2 ml-6 rounded-[20px] shadow-sm border-gray-300 min-w-[200px] focus:outline-none focus:ring-2 focus:ring-green-login">
      ...
      <div className="px-8 py-4 my-2">
        <div className="flex flex-row justify-between items-center">
          ...
          <div className="flex flex-row gap-10">
            <button className="bg-green-500 hover:bg-green-400 text-white font-Outfit-Bold h-10 w-[10rem] rounded-[20px]" type="button" onClick={handleRooms}>ARRSecond-HalfGE</button>
