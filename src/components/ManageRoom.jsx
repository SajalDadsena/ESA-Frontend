    ...
    return (
        <div className="bg-background flex flex-col flex-grow md:w-5/6">
            <div className="px-8 pt-4 mt-6">
                ...
                <form ref={formRef} className="flex flex-col justify-between" onSubmit={handleRoom}>
                    <Input input_id="room-no" title="Room No" inputRef={roomNoRef} type="text" placeholder="S1" required />
                    <DropDownInput id="branch" title="Floor No" inputRef={floorNoRef} options={['0','1', '2',]} required />
                    <DropDownInput id="slot" title="Department" inputRef={blockRef} options={['CSE', 'IT','Mech','EE','ECE','Civil','Meta','Mining','BME']} required />
